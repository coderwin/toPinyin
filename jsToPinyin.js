...
/*hash 搜索*/
var _hashSearch = function(str, objt){
	for (var key in objt) {
...
ToPinyin.prototype = {
	...
	toPinyin: function(str,camel){
        ...
        for (var i = 0; i < length; i++) {
            ...
            curPinyinVal = _hashSearch(curVal, source);
            /*是否需要驼峰式*/
            if(camel&&camel==true&&curPinyinVal!==false) {
            	curPinyinVal = _ucfirst(curPinyinVal);
            }
            if (reg.test(curVal)) {
                pinyinCamel += curVal;
